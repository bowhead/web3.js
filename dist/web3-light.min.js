require = function() {
        ...
        d.prototype._requireType = function(t) {
            ...
            if (c !== s) {
                ...
                if (e.isDynamicArray(u))
                    for (var l = c === i ? 2 : 0, h = 0; h < r.length; h++) c === i ? l += +r[h - 1][0] || 0 : c === a && (l += +(r[h - 1] || [])[0] || 0), p += n.formatInputInt(o + h * f + 32 * l).encode();
                for (var d = c === i ? r.length - 1 : r.length, m = 0; m < d; m++) {
                    var y = p / 2;
                    c === i ? p += this.encodeWithOffset(u, e, r[m + 1], o + y) : c === a && (p += this.encodeWithOffset(u, e, r[m], o + y))
                }
                return p
            }
            return r
    ...
    14: [function(t, e, r) {
        ...
        i.prototype.isType = function(t) {
            ...
            if (this.isDynamicArray(r)) return function() {
                for (var n = parseInt("0x" + t.substr(2 * e, 64)), o = parseInt("0x" + t.substr(2 * n, 64)), i = n + 32, a = c.nestedName(r), s = c.staticPartLength(a), u = 32 * Math.floor((s + 31) / 32), f = [], p = 0; p < o * u; p += u) f.push(c.decode(t, i + p, a));
                return f
            }();
    ...
    18: [function(t, e, r) {
        ...
        e.exports = {
            ...
            AHT_UNITS: ['cell','kcell','Kcell','mcell','Mcell','gcell','Gcell','organ','korgan','Korgan','morgan','Morgan','gorgan','Gorgan','aht'],
    ...
    22: [function(t, e, r) {
        ...
        function w(t) {
            this._requestManager = new n(t), this.currentProvider = t, this.aht = new i(this), this.db = new a(this), this.shh = new s(this), this.net = new c(this), this.personal = new u(this), this.bzz = new f(this), this.settings = new p, this.version = {
                api: l.version
            }, this.providers = {
                HttpProvider: v,
                IpcProvider: b
    ...
    25: [function(t, e, r) {
        var n = t("../utils/utils"),
            ...
            f = function(t) {
                ...
                new s(t._aht._requestManager, e, t.address).attachToContract(t), e.map(function(e) {
            ...
            p = function(t, e) {
                var r = 0,
                    n = !1,
                    o = t._aht.filter("latest", function(i) {
                        if (!i && !n)
                            if (++r > 50) {
                            ...
                            } else t._aht.getTransactionReceipt(t.transactionHash, function(r, i) {
                                i && i.blockHash && !n && t._aht.getCode(i.contractAddress, function(r, a) {
                                    if (!n && a)
            ...
            l = function(t, e) {
                this.aht = t, this.abi = e, this.new = function() {
                    var t, r = new h(this.aht, this.abi),
                        o = {},
                    ...
                    var s = c(this.abi, i);
                    if (o.data += s, t) this.aht.sendTransaction(o, function(e, n) {
                        e ? t(e) : (r.transactionHash = n, t(null, r), p(r, t))
                    });
                    else {
                        var u = this.aht.sendTransaction(o);
                        r.transactionHash = u, p(r)
                    }
                    return r
        ...
        var h = function(t, e, r) {
            this._aht = t, this.transactionHash = null, this.address = r, this.abi = e
        };
        e.exports = l
    }, {
        "../solidity/coder": 7,
        ...
        var n = t("./formatters"),
            ...
            c = function(t, e, r, c, u, f, p) {
                ...
                return c.forEach(function(t) {
                    ...
                    if (t) l.callbacks.forEach(function(e) {
                        e(t)
                    }), "function" == typeof p && p(t);
                    else if (l.filterId = e, l.getLogsCallbacks.forEach(function(t) {
                            l.get(t)
                        }), l.getLogsCallbacks = [], l.callbacks.forEach(function(t) {
                            a(l, t)
                        }), l.callbacks.length > 0 && s(l), "function" == typeof f) return l.watch(f)
                }), this
            };
    ...
    31: [function(t, e, r) {
        var n = t("../solidity/coder"),
            ...
            s = t("../utils/sha3"),
            c = function(t, e, r) {
                this._aht = t, this._inputTypes = e.inputs.map(function(t) {
                    return t.type
        ...
        c.prototype.extractCallback = function(t) {
            ...
            var t = Array.prototype.slice.call(arguments).filter(function(t) {
                ...
                n = this.toPayload(t);
            if (!e) {
                var o = this._aht.call(n, r);
                return this.unpackOutput(o)
            }
            var i = this;
            this._aht.call(n, r, function(t, r) {
            ...
            if (!e) return this._aht.sendTransaction(r);
            this._aht.sendTransaction(r, e)
        }, c.prototype.estimateGas = function() {
            var t = Array.prototype.slice.call(arguments),
                e = this.extractCallback(t),
                r = this.toPayload(t);
            if (!e) return this._aht.estimateGas(r);
            this._aht.estimateGas(r, e)
    ...
    32: [function(t, e, r) {
        ...
        var o = t("xhr2"),
            i = function(t, e, r, n, o) {
                this.host = t || "http://localhost:9634", this.timeout = e || 0, this.user = r, this.password = n, this.headers = o
            };
    ...
    33: [function(t, e, r) {
        ...
        s.fromAddress = function(t) {
            ...
            return s.fromBban("AHT" + t.institution + t.identifier)
        }, s.isValid = function(t) {
            return new s(t).isValid()
        }, s.prototype.isValid = function() {
            return /^XE[0-9]{2}(AHT[0-9A-Z]{13}|[0-9A-Z]{30,31})$/.test(this._iban) && 1 === a(i(this._iban))
    ...
    38: [function(t, e, r) {
        ...
        var n = t("../formatters"),
            ...
            d = t("../transfer"),
            m = function(t) {
                return o.isString(t[0]) && 0 === t[0].indexOf("0x") ? "aht_getBlockByHash" : "aht_getBlockByNumber"
            },
            y = function(t) {
                return o.isString(t[0]) && 0 === t[0].indexOf("0x") ? "aht_getTransactionByBlockHashAndIndex" : "aht_getTransactionByBlockNumberAndIndex"
            },
            g = function(t) {
                return o.isString(t[0]) && 0 === t[0].indexOf("0x") ? "aht_getUncleByBlockHashAndIndex" : "aht_getUncleByBlockNumberAndIndex"
            },
            v = function(t) {
                return o.isString(t[0]) && 0 === t[0].indexOf("0x") ? "aht_getBlockTransactionCountByHash" : "aht_getBlockTransactionCountByNumber"
            },
            b = function(t) {
                return o.isString(t[0]) && 0 === t[0].indexOf("0x") ? "aht_getUncleCountByBlockHash" : "aht_getUncleCountByBlockNumber"
            };
        ...
        var w = function() {
                ...
                return [t, e, r, a, s, c, u, f, p, l, h, d, new i({
                    name: "call",
                    call: "aht_call",
                    params: 2,
        ...
        _.prototype.contract = function(t) {
            ...
            return new f(t, "aht", this._requestManager, u.aht(), n.outputLogFormatter, e, r)
            ...
            aht: function() {
                return [new n({
                    ...
                    call: function(t) {
                        switch (t[0]) {
                            case "latest":
                                return t.shift(), this.params = 0, "aht_newBlockFilter";
                            case "pending":
                                return t.shift(), this.params = 0, "aht_newPendingTransactionFilter";
                            default:
    ...
    46: [function(t, e, r) {
        ...
        s.prototype.send = function(t) {
            ...
            if (this.timeout = setTimeout(this.poll.bind(this), i.AHT_POLLING_TIMEOUT), 0 !== Object.keys(this.polls).length)
                if (this.provider) {
                    var t = [],
                        e = [];
            ...
            return function() {
                ...
                ! function() {
                    ...
                    for (e = 0; e < 256; e++) {
                        ...
                        f[d] = v << 24 | v >>> 8, p[d] = v << 16 | v >>> 16, l[d] = v << 8 | v >>> 24, h[d] = v, r ? (r = m ^ t[t[t[g ^ m]]], n ^= t[t[n]]) : r = n = 1
                    }
                }();
                var d = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
                    m = n.AES = r.extend({
                        _doReset: function() {
                            if (!this._nRounds || this._keyPriorReset !== this._key) {
                                ...
                                for (var c = this._invKeySchedule = [], u = 0; u < n; u++) {
                                    ...
                                    c[u] = u < 4 || a <= 4 ? s : f[o[s >>> 24]] ^ p[o[s >>> 16 & 255]] ^ l[o[s >>> 8 & 255]] ^ h[o[255 & s]]
                                }
                            }
                        },
                        ...
                        decryptBlock: function(t, e) {
                            var r = t[e + 1];
                            t[e + 1] = t[e + 3], t[e + 3] = r, this._doCryptBlock(t, e, this._invKeySchedule, f, p, l, h, i);
                            r = t[e + 1];
                            t[e + 1] = t[e + 3], t[e + 3] = r
                        },
                        _doCryptBlock: function(t, e, r, n, o, i, a, s) {
                            for (var c = this._nRounds, u = t[e] ^ r[0], f = t[e + 1] ^ r[1], p = t[e + 2] ^ r[2], l = t[e + 3] ^ r[3], h = 4, d = 1; d < c; d++) {
                                var m = n[u >>> 24] ^ o[f >>> 16 & 255] ^ i[p >>> 8 & 255] ^ a[255 & l] ^ r[h++],
                                    y = n[f >>> 24] ^ o[p >>> 16 & 255] ^ i[l >>> 8 & 255] ^ a[255 & u] ^ r[h++],
                                    g = n[p >>> 24] ^ o[l >>> 16 & 255] ^ i[u >>> 8 & 255] ^ a[255 & f] ^ r[h++],
                                    v = n[l >>> 24] ^ o[u >>> 16 & 255] ^ i[f >>> 8 & 255] ^ a[255 & p] ^ r[h++];
                                u = m, f = y, p = g, l = v
                            }
                            m = (s[u >>> 24] << 24 | s[f >>> 16 & 255] << 16 | s[p >>> 8 & 255] << 8 | s[255 & l]) ^ r[h++], y = (s[f >>> 24] << 24 | s[p >>> 16 & 255] << 16 | s[l >>> 8 & 255] << 8 | s[255 & u]) ^ r[h++], g = (s[p >>> 24] << 24 | s[l >>> 16 & 255] << 16 | s[u >>> 8 & 255] << 8 | s[255 & f]) ^ r[h++], v = (s[l >>> 24] << 24 | s[u >>> 16 & 255] << 16 | s[f >>> 8 & 255] << 8 | s[255 & p]) ^ r[h++];
    ...
    52: [function(t, e, r) {
        var n, o;
        n = this, o = function(t) {
            var e, r, n, o, i, a, s, c, u, f, p, l, h, d, m, y, g, v, b;
            t.lib.Cipher || (n = (r = t).lib, o = n.Base, i = n.WordArray, a = n.BufferedBlockAlgorithm, (s = r.enc).Utf8, c = s.Base64, u = r.algo.EvpKDF, f = n.Cipher = a.extend({
                ...
                blockSize: 1
            }), p = r.mode = {}, l = n.BlockCipherMode = o.extend({
                createEncryptor: function(t, e) {
    ...
    53: [function(t, e, r) {
        var n, o;
        n = this, o = function() {
            var t, e, r, n, o, i, a, s, c, u, f, p, l = l || (t = Math, e = Object.create || function() {
                function t() {}
                return function(e) {
                    var r;
    ...
    72: [function(t, e, r) {
        ...
        n = this, o = function(t) {
            ...
            return r = (e = t).lib, n = r.Base, o = r.WordArray, i = e.algo, a = i.SHA1, s = i.HMAC, c = i.PBKDF2 = n.extend({
                ...
                compute: function(t, e) {
                    for (var r = this.cfg, n = s.create(r.hasher, t), i = o.create(), a = o.create([1]), c = i.words, u = a.words, f = r.keySize, p = r.iterations; c.length < f;) {
                        ...
                        _doReset: function() {
                            ...
                            if (e) {
                                var i = e.words,
                                    ...
                                    p = u >>> 16 | 4294901760 & f,
                                    l = f << 16 | 65535 & u;
                                n[0] ^= u, n[1] ^= p, n[2] ^= f, n[3] ^= l, n[4] ^= u, n[5] ^= p, n[6] ^= f, n[7] ^= l;
                ...
                var r = t,
                    ...
                    h = a.RIPEMD160 = i.extend({
                        ...
                        _doProcessBlock: function(t, e) {
                            ...
                            var i, a, h, _, w, x, k, B, S, C, A, F = this._hash.words,
                                T = p.words,
                                P = l.words,
                                I = s.words,
                                D = c.words,
                                M = u.words,
                                O = f.words;
                            x = i = F[0], k = a = F[1], B = h = F[2], S = _ = F[3], C = w = F[4];
                            for (r = 0; r < 80; r += 1) A = i + t[e + I[r]] | 0, A += r < 16 ? d(a, h, _) + T[0] : r < 32 ? m(a, h, _) + T[1] : r < 48 ? y(a, h, _) + T[2] : r < 64 ? g(a, h, _) + T[3] : v(a, h, _) + T[4], A = (A = b(A |= 0, M[r])) + w | 0, i = w, w = _, _ = b(h, 10), h = a, a = A, A = x + t[e + D[r]] | 0, A += r < 16 ? v(k, B, S) + P[0] : r < 32 ? g(k, B, S) + P[1] : r < 48 ? y(k, B, S) + P[2] : r < 64 ? m(k, B, S) + P[3] : d(k, B, S) + P[4], A = (A = b(A |= 0, O[r])) + C | 0, x = C, C = S, S = b(B, 10), B = k, k = A;
                            A = F[1] + h + S | 0, F[1] = F[2] + _ + C | 0, F[2] = F[3] + w + x | 0, F[3] = F[4] + i + k | 0, F[4] = F[0] + a + B | 0, F[0] = A
                        },
                        _doFinalize: function() {
                            var t = this._data,
                                e = t.words,
            ...
            return r = (e = t).lib, n = r.WordArray, o = r.Hasher, i = e.algo, a = [], s = i.SHA1 = o.extend({
                ...
                _doProcessBlock: function(t, e) {
                    for (var r = this._hash.words, n = r[0], o = r[1], i = r[2], s = r[3], c = r[4], u = 0; u < 80; u++) {
                        ...
                        p += u < 20 ? 1518500249 + (o & i | ~o & s) : u < 40 ? 1859775393 + (o ^ i ^ s) : u < 60 ? (o & i | o & s | i & s) - 1894007588 : (o ^ i ^ s) - 899497514, c = s, s = i, i = o << 30 | o >>> 2, o = n, n = p
                    }
            ...
            return function(e) {
                ...
                var u = [],
                    f = a.SHA256 = i.extend({
                        ...
                        _doProcessBlock: function(t, e) {
                            for (var r = this._hash.words, n = r[0], o = r[1], i = r[2], a = r[3], s = r[4], f = r[5], p = r[6], l = r[7], h = 0; h < 64; h++) {
                                if (h < 16) u[h] = 0 | t[e + h];
                                else {
                                    var d = u[h - 15],
                                ...
                                var v = n & o ^ n & i ^ o & i,
                                    ...
                                    _ = l + ((s << 26 | s >>> 6) ^ (s << 21 | s >>> 11) ^ (s << 7 | s >>> 25)) + (s & f ^ ~s & p) + c[h] + u[h];
                                l = p, p = f, f = s, s = a + _ | 0, a = i, i = o, o = n, n = _ + (b + v) | 0
                            }
                            r[0] = r[0] + n | 0, r[1] = r[1] + o | 0, r[2] = r[2] + i | 0, r[3] = r[3] + a | 0, r[4] = r[4] + s | 0, r[5] = r[5] + f | 0, r[6] = r[6] + p | 0, r[7] = r[7] + l | 0
                        },
                        _doFinalize: function() {
                            var t = this._data,
                                r = t.words,
                            ...
                            for (l = 0; l < 5; l++)
                                for (m = 0; m < 5; m++) {
                                    var F = r[w = l + 5 * m],
                                        ...
                                        P = p[(l + 1) % 5 + 5 * m],
                                        I = p[(l + 2) % 5 + 5 * m];
                                    F.high = T.high ^ ~P.high & I.high, F.low = T.low ^ ~P.low & I.low
                                }
                            F = r[0];
                            var D = f[s];
        ...
        n = this, o = function(t) {
            return function() {
                ...
                var f = a.SHA512 = r.extend({
                    ...
                    _doProcessBlock: function(t, e) {
                        for (var r = this._hash.words, n = r[0], o = r[1], i = r[2], a = r[3], s = r[4], f = r[5], p = r[6], l = r[7], h = n.high, d = n.low, m = o.high, y = o.low, g = i.high, v = i.low, b = a.high, _ = a.low, w = s.high, x = s.low, k = f.high, B = f.low, S = p.high, C = p.low, A = l.high, F = l.low, T = h, P = d, I = m, D = y, M = g, O = v, E = b, R = _, H = w, N = x, j = k, z = B, q = S, L = C, U = A, W = F, J = 0; J < 80; J++) {
                            var K = u[J];
                            ...
                            var pt, lt = H & j ^ ~H & q,
                                ...
                                dt = T & I ^ T & M ^ I & M,
                                mt = P & D ^ P & O ^ D & O,
                                yt = (T >>> 28 | P << 4) ^ (T << 30 | P >>> 2) ^ (T << 25 | P >>> 7),
                                gt = (P >>> 28 | T << 4) ^ (P << 30 | T >>> 2) ^ (P << 25 | T >>> 7),
                                vt = (H >>> 14 | N << 18) ^ (H >>> 18 | N << 14) ^ (H << 23 | N >>> 9),
                                bt = (N >>> 14 | H << 18) ^ (N >>> 18 | H << 14) ^ (N << 23 | H >>> 9),
                                _t = c[J],
                                wt = _t.high,
                                xt = _t.low,
                                kt = U + vt + ((pt = W + bt) >>> 0 < W >>> 0 ? 1 : 0),
                                Bt = gt + mt;
                            U = q, W = L, q = j, L = z, j = H, z = N, H = E + (kt = (kt = (kt = kt + lt + ((pt = pt + ht) >>> 0 < ht >>> 0 ? 1 : 0)) + wt + ((pt = pt + xt) >>> 0 < xt >>> 0 ? 1 : 0)) + G + ((pt = pt + X) >>> 0 < X >>> 0 ? 1 : 0)) + ((N = R + pt | 0) >>> 0 < R >>> 0 ? 1 : 0) | 0, E = M, R = O, M = I, O = D, I = T, D = P, T = kt + (yt + dt + (Bt >>> 0 < gt >>> 0 ? 1 : 0)) + ((P = pt + Bt | 0) >>> 0 < pt >>> 0 ? 1 : 0) | 0
                        }
                        d = n.low = d + P, n.high = h + T + (d >>> 0 < P >>> 0 ? 1 : 0), y = o.low = y + D, o.high = m + I + (y >>> 0 < D >>> 0 ? 1 : 0), v = i.low = v + O, i.high = g + M + (v >>> 0 < O >>> 0 ? 1 : 0), _ = a.low = _ + R, a.high = b + E + (_ >>> 0 < R >>> 0 ? 1 : 0), x = s.low = x + N, s.high = w + H + (x >>> 0 < N >>> 0 ? 1 : 0), B = f.low = B + z, f.high = k + j + (B >>> 0 < z >>> 0 ? 1 : 0), C = p.low = C + L, p.high = S + q + (C >>> 0 < L >>> 0 ? 1 : 0), F = l.low = F + W, l.high = A + U + (F >>> 0 < W >>> 0 ? 1 : 0)
                    },
                    _doFinalize: function() {
                        var t = this._data,
                            e = t.words,
        ...
        n = this, o = function(t) {
            return function() {
                var e = t,
                    ...
                    p = i.DES = o.extend({
                        ...
                        _doCryptBlock: function(t, e, r) {
                            this._lBlock = t[e], this._rBlock = t[e + 1], l.call(this, 4, 252645135), l.call(this, 16, 65535), h.call(this, 2, 858993459), h.call(this, 8, 16711935), l.call(this, 1, 1431655765);
                            for (var n = 0; n < 16; n++) {
                                for (var o = r[n], i = this._lBlock, a = this._rBlock, s = 0, c = 0; c < 8; c++) s |= u[c][((a ^ o[c]) & f[c]) >>> 0];
                                this._lBlock = a, this._rBlock = i ^ s
                            }
                            var p = this._lBlock;
                            this._lBlock = this._rBlock, this._rBlock = p, l.call(this, 1, 1431655765), h.call(this, 8, 16711935), h.call(this, 2, 858993459), l.call(this, 16, 65535), l.call(this, 4, 252645135), t[e] = this._lBlock, t[e + 1] = this._rBlock
                        },
                        keySize: 2,
                        ivSize: 2,
                        blockSize: 2
                ...
                var d = i.TripleDES = o.extend({
                    _doReset: function() {
                        var t = this._key.words;
                        this._des1 = p.createEncryptor(n.create(t.slice(0, 2))), this._des2 = p.createEncryptor(n.create(t.slice(2, 4))), this._des3 = p.createEncryptor(n.create(t.slice(4, 6)))
                    },
                    encryptBlock: function(t, e) {
    ...
    85: [function(t, e, r) {
        ! function(t) {
            ...
            function h(t) {
                ...
                var e = "";
                return 0 == (4294965248 & t) ? e = u(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (p(t), e = u(t >> 12 & 15 | 224), e += l(t, 6)) : 0 == (4292870144 & t) && (e = u(t >> 18 & 7 | 240), e += l(t, 12), e += l(t, 6)), e += u(63 & t | 128)
            }
            ...
            function m() {
                ...
                if (224 == (240 & t)) {
                    if ((e = (15 & t) << 12 | d() << 6 | d()) >= 2048) return p(e), e;
                    throw Error("Invalid continuation byte")
                }
