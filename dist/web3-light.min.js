require = function() {
    ...
    23: [function(t, e, r) {
        ...
        u.prototype.encode = function(t) {
            ...
            return new s(r, "eth", this._requestManager, c.aht(), n, e)
    ...
    27: [function(t, e, r) {
        ...
        u.prototype.types = function(t) {
            ...
            return new s(o, "eth", this._requestManager, c.aht(), i, r)
        }, u.prototype.attachToContract = function(t) {
            var e = this.execute.bind(this),
                r = this.displayName();
    ...
    38: [function(t, e, r) {
        ...
        _.prototype.contract = function(t) {
            ...
            return new f(t, "eth", this._requestManager, u.aht(), n.outputLogFormatter, e, r)
