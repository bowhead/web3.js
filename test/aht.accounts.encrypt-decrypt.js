var Accounts = require("./../packages/web3-aht-accounts/src/index.js");
...
// tests from https://github.com/Gustav-Simonsson/go-bowhead/blob/7cc6b801e0967e5ebfa26b9f670675acea6e3a20/accounts/testdata/v3_test_vector.json
var staticTests = [{
    "json": {
        "crypto" : {
            "cipher" : "aes-128-ctr",
...
describe("aht", function () {
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            it("encrypt aht.account, and compare to bowheadjs-wallet", function() {
                ...
                assert.deepEqual(acc.encrypt(pw, {n: n,salt: salt, iv: iv, uuid: uuid}), ahtWall.toV3(pw, {n: n, salt: salt, iv: iv, uuid: uuid}));
            });

            it("encrypt aht.account, and decrypt with bowheadjs-wallet", function() {
                var ahtAccounts = new Accounts();
                ...
                // create bowheadjs-wallet account
                var ahtWall = bowheadWallet.fromV3(encrypt, pw);
            ...
            it("encrypt bowheadjs-wallet, and decrypt with aht.account", function() {
                var ahtAccounts = new Accounts();

                // create account
                var ahtWall = bowheadWallet.generate();
                var encrypt = ahtWall.toV3(pw, {n: n});

                // create bowheadjs-wallet account
                var acc = ahtAccounts.decrypt(encrypt, pw);
            ...
            it("decrypt static signature using bowheadjs-wallet and aht.account and compare", function() {
                var ahtAccounts = new Accounts();
                ...
                var acc = ahtAccounts.decrypt(encrypt, pw);
                var ahtWall = bowheadWallet.fromV3(encrypt, 'test');
        ...
        staticTests.forEach(function (test, i) {
            it("decrypt staticTests and compare to private key", function() {
                ...
                // create account
                var acc = ahtAccounts.decrypt(test.json, test.password);
