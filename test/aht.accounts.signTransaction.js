...
var ahtjsSigner = require("aht.s-signer");
...
var tests = [
    {
        ...
        // signature from aht_signTransaction
    ...
    },
    {
        ...
        // web3.aht.signTransaction({from: "0xEB014f8c8B418Db6b45774c326A0E64C78914dC0", gasPrice: "230000000000", gas: "50000", to: '0xFCAd0B19bB29D4674531d6f115237E16AfCE377c', value: "1000000000000000000", data: "0x0123abcd"}).then(console.log);
        // signature from aht_signTransaction
        ...
        tests.forEach(function (test, i) {
            if (test.error) {
                ...
                it("signTransaction must error", function(done) {
                    ...
                    var testAccount = ahtAccounts.privateKeyToAccount(test.privateKey);
                ...
                it("signTransaction must compare to aht_signTransaction", function(done) {
                    var ahtAccounts = new Accounts();
                ...
                it("signTransaction using the iban as \"to\" must compare to aht_signTransaction", function(done) {
                    var ahtAccounts = new Accounts();
                ...
                it("signTransaction will call for nonce", function(done) {
                    ...
                    var ahtAccounts = new Accounts(web3);
                ...
                it("recoverTransaction, must recover signature", function() {
                    ...
                    testAccount.signTransaction(test.transaction).then(function (tx) {
                        assert.equal(aht.ccounts.recoverTransaction(tx.rawTransaction), test.address);
                    });
                });

                it("recoverTransaction, must also recover old signature from aht-signer", function() {
                    var ahtAccounts = new Accounts();

                    var oldSignature = ahtjsSigner.sign(test.transaction, test.privateKey);

                    assert.equal(aht.ccounts.recoverTransaction(oldSignature), test.address);
                });
            }
        });
    });
