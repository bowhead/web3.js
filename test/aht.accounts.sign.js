    ...
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            it("sign data using a string", function() {
                ...
                var data = ahtAccounts.sign(test.data, test.privateKey);
            ...
            it("sign data using a utf8 encoded hex string", function() {
                ...
                var data = ahtAccounts.sign(data, test.privateKey);
            ...
            it("recover signature using a string", function() {
                ...
                var address = ahtAccounts.recover(test.data, test.signature);
            ...
            it("recover signature using a string and preFixed", function() {
                ...
                var address = ahtAccounts.recover(ahtAccounts.hashMessage(test.data), test.signature, true);
            ...
            it("recover signature using a hash and r s v values and preFixed", function() {
                ...
                var sig = ahtAccounts.sign(test.data, test.privateKey);
                var address = ahtAccounts.recover(ahtAccounts.hashMessage(test.data), sig.v, sig.r, sig.s, true);
            ...
            it("recover signature (pre encoded) using a signature object", function() {
                ...
                var data = web3.utils.isHexStrict(test.data) ? test.data : web3.utils.utf8ToHex(test.data);
                var sig = ahtAccounts.sign(data, test.privateKey);
                var address = ahtAccounts.recover(sig);
            ...
            it("recover signature (pre encoded) using a hash and r s v values", function() {
                ...
                var data = web3.utils.isHexStrict(test.data) ? test.data : web3.utils.utf8ToHex(test.data);
                var sig = ahtAccounts.sign(data, test.privateKey);
                var address = ahtAccounts.recover(test.data, sig.v, sig.r, sig.s);
