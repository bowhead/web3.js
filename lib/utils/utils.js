 ...
 * - kcell       femtaht     babbage
 * - mcell       picaht      lovelace
 * - gcell       nanaht      shannon      nano
 * - --         micraht     szabo        micro
 * - --         millaht     finney       milli
 * -aht      --             --
 * - aht                    --           grand
 * - aht
 * - aht
 ...
 * Possible units are:
 *   SI Short   SI Full        Effigy       Other
 * - kcell       femt aht     babbage
 * - mcell       pic aht      lovelace
 * - gcell       nan aht      shannon      nano
 * - --         micr aht     szabo        micro
 * - --         mill aht     finney       milli
 * - aht      --             --
 * -  aht                    --           grand
 * -  aht
 * -  aht
