...
var packages = [{
    ...
    fileName: 'web3-aht',
    expose: 'Web3Eth',
    src: './packages/web3-aht/src/index.js'
}, {
    fileName: 'web3-aht-accounts',
    expose: 'Web3EthAccounts',
    src: './packages/web3-aht-accounts/src/index.js'
}, {
    fileName: 'web3-aht-contract',
    expose: 'Web3EthContract',
    src: './packages/web3-aht-contract/src/index.js'
}, {
    fileName: 'web3-aht-personal',
    expose: 'Web3EthPersonal',
    src: './packages/web3-aht-personal/src/index.js'
}, {
    fileName: 'web3-aht-iban',
    expose: 'Web3EthIban',
    src: './packages/web3-aht-iban/src/index.js'
}, {
    fileName: 'web3-aht-abi',
    expose: 'Web3EthAbi',
    src: './packages/web3-aht-abi/src/index.js'
}, {
    fileName: 'web3-net',
    expose: 'Web3Net',
