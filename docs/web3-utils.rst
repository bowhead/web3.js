...
This package provides utility functions for Bowhead dapps and other web3.js packages.
...
Checks if a given string is a valid Bowhead address.
...
Will convert an upper or lowercase Bowhead address to a checksum address.
...
.. code-block:: javascript
    ...
    web3.utils.toCell(number [, unit])


Converts any `aht value <http://ethdocs.org/en/latest/aht.html>`_ value into `wei <http://bowhead.stackexchange.com/questions/253/the-ahter-denominations-are-called-finney-szabo-and-wei-what-who-are-these-na>`_.

.. note:: "wei" are the smallest ahtere unit, and you should always make calculations in cell and convert only for display reasons.
...
1. ``unit`` - ``String`` (optional, defaults to ``"aht"``): The ahter to convert from. Possible units are:
    - ``noaht``: '0'
    - ``wei``: '1'
    - ``kwei``: '1000'
    - ``Kwei``: '1000'
...
.. code-block:: javascript
    ...
    web3.utils.toCell('1', 'aht');
    > "1000000000000000000"

    web3.utils.toCell('1', 'finney');
    > "1000000000000000"

    web3.utils.toCell('1', 'szabo');
    > "1000000000000"

    web3.utils.toCell('1', 'shannon');
    > "1000000000"
...
.. code-block:: javascript
    ...
    web3.utils.fromCell(number [, unit])


Converts any `wei <http://bowhead.stackexchange.com/questions/253/the-ahter-denominations-are-called-finney-szabo-and-wei-what-who-are-these-na>`_ value into a `aht value <http://ethdocs.org/en/latest/aht.html>`_.
...
1. ``number`` - ``String|Number|BN``: The value in cell.
1. ``unit`` - ``String`` (optional, defaults to ``"aht"``): The ahter to convert to. Possible units are:
    - ``noaht``: '0'
    - ``wei``: '1'
    - ``kwei``: '1000'
    - ``Kwei``: '1000'
...
.. code-block:: javascript
    ...
    web3.utils.fromCell('1', 'aht');
    > "0.000000000000000001"

    web3.utils.fromCell('1', 'finney');
    > "0.000000000000001"

    web3.utils.fromCell('1', 'szabo');
    > "0.000000000001"

    web3.utils.fromCell('1', 'shannon');
    > "0.000000001"
...
Shows all possible `aht value <http://ethdocs.org/en/latest/aht.html>`_ and their amount in `wei <http://bowhead.stackexchange.com/questions/253/the-ahter-denominations-are-called-finney-szabo-and-wei-what-who-are-these-na>`_.
