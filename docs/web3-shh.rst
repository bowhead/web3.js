...
For more see `Whisper  Overview <https://github.com/bowhead/go-bowhead/wiki/Whisper>`_.
...
.. code-block:: javascript
    ...
    // "Shh.providers.givenProvider" will be set if in an Bowhead supported browser.
...
.. note:: This will not reset subscriptions from other packages like ``web3-aht``, as they use their own requestManager.
