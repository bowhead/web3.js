...
.. code-block:: javascript
    ...
    // will autodetect if the "bowhead" object is present and will either connect to the local swarm node, or the swarm-gateways.net.
    ...
    // -> web3.bzz.currentProvider // if Web3.givenProvider was an bowhead provider it will set: "http://localhost:8500" otherwise it will set: "http://swarm-gateways.net"
